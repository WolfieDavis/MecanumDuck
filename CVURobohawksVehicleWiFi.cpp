...
void handleJoyStickData(CVURobohawksVehicleWiFi *WiFi)
{
  ...
  *WiFi->mLFptr = WiFi->server.arg("mLF").toInt();
  *WiFi->mLBptr = WiFi->server.arg("mLB").toInt();
  *WiFi->mRFptr = WiFi->server.arg("mRF").toInt();
  *WiFi->mRBptr = WiFi->server.arg("mRB").toInt();
 ...
 */
void CVURobohawksVehicleWiFi::setUpWiFi(char *wifiName, char *wifiPass, int chanel, int &mLF, int &mLB, int &mRF, int &mRB) // setUpWiFi(char *wifiName, char *wifiPass, int chanel, int &joyStickXVar, int &joyStickYVar, int &leftWheelError, int &rightWheelError, void saveWheelErrorFunction(int, int), void autoFunction())
{
